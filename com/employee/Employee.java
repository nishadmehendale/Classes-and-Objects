...
public class Employee {
	...
	public String toString() {
		return "Employee [Monthly Basic=" + monthlyBasic + ", Employee Id=" + getEmployeeId() + ", Employee Name="
				+ getEmployeeName() + ", Monthly Basic=" + getMonthlyBasic() + ", Hra=" + getHra() + ", Pf=" + getPf()
				...
				+ getAnnualGrossSalary() + ", Monthly Deductions=" + getMonthlyDeductions() + ", Monthly Take Home="
				+ getMonthlyTakeHome() + ", Annual Take Home=" + getAnnualTakeHome() + ", Esic=" + getEsic() + "]";
	}
